...
if (isMobileDevice) {
    // Disabilita le ombre e il test di profondità per i dispositivi mobili
    viewer.shadows = false;
    // Disabilita il test di profondità contro il terreno
    viewer.scene.globe.depthTestAgainstTerrain = false;
    // Disabilita le ombre per il modello 3D
